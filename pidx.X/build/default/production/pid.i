...
static float kProportional;
static float kIntegral;
static float kDerivative;

int pid_scaleExcitation ( float activation) {
...
void pid_setPoint(float position) {
setPoint = position;
}

void pid_setDerivativeGain(float gain) {
kDerivative = gain;
}

void pid_setIntegralGain(float gain) {
kIntegral = gain;
}

void pid_setProportionalGain(float gain) {
kProportional = gain;
}
