...
# 7 "D:\Microchip\xc8\v2.05\pic\include\c90\stdlib.h"
...
# 18 "position_controller.h"
extern unsigned char printBuffer[10];
...
# 13 "position_sensor.h"
extern int pos_getCurrentPosition();
extern void pos_setCurrentPosition(int pos);
...
extern void pid_setProportionalGain ( float gain);
extern void pid_setIntegralGain ( float gain);
extern void pid_setDerivativeGain ( float gain);
extern void pid_setPoint ( float position);
extern void pid_pid();
...
# 6 "utils.h"
extern float convertToReal(unsigned char* chars);
extern void printReal( float value);

# 11 "position_sensor_implementation.h"
volatile static int pos_currentPosition;
...
int pos_getCurrentPosition() {
return pos_currentPosition;
}

void pos_setCurrentPosition(int pos) {
...
# 13 "multitasking_implementation.h"
