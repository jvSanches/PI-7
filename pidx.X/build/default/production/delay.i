...
{
i--;
{ delayus_variable=(unsigned char)(253/1); asm("nop"); asm("nop"); } asm("decfsz _delayus_variable,f"); asm("goto $ - 3");;
asm("clrwdt");
}
{ delayus_variable=(unsigned char)((unsigned char)(cnt & 0xFF)/1); asm("nop"); asm("nop"); } asm("decfsz _delayus_variable,f"); asm("goto $ - 3");;
}
...
i = 4;
do {
{ delayus_variable=(unsigned char)(250/1); asm("nop"); asm("nop"); } asm("decfsz _delayus_variable,f"); asm("goto $ - 3");;
asm("clrwdt");
} while(--i);
} while(--cnt);
}
