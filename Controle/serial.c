...
#include <xc.h>     // [jo:130813] para compilador XC8
#include <conio.h>
#include <stdio.h>
#include "always.h"
#include "delay.h"
...
//  return 0;
  return 255; // [jo:130816] retorna 255 para compatibilidade com chkchr()
}
...
// [jo:091211] Verifica se um caracter chegou pela serial.
// Se chegou retorna o caracter
// sen‹o retorna 255
...
/*int parseInt(){
    ...
    while (!eol){
        ...
        while (buff >= buff_start){
            out_val = out_val * 10;
            out_val = out_val + *buff_start;
            buff_start++;
