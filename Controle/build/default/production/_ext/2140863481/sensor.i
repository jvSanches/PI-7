...
# 14 "../Lab6_/adc.h"
extern void adc_init (unsigned char ADC_Channel);

extern unsigned int adc_read(unsigned char ADC_Channel);
...
{ delayus_variable=(unsigned char)(100/1); asm("nop"); asm("nop"); } asm("decfsz _delayus_variable,f"); asm("goto $ - 3");;

TRISA |= 0b00011100;
delay_big_us(800);
int line_reading = (PORTA & 0b00011100) >> 2;
