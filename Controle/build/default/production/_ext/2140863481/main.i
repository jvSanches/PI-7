...
# 13 "D:\Microchip\xc8\v2.05\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 52 "D:\Microchip\xc8\v2.05\pic\include\pic16f886.h"
...
# 30 "D:\Microchip\xc8\v2.05\pic\include\pic.h"
...
# 114 "D:\Microchip\xc8\v2.05\pic\include\eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);


# 91 "D:\Microchip\xc8\v2.05\pic\include\pic.h"
...
# 4 "D:\Microchip\xc8\v2.05\pic\include\__size_t.h"
typedef unsigned size_t;

# 7 "D:\Microchip\xc8\v2.05\pic\include\c90\stdarg.h"
...
# 43 "D:\Microchip\xc8\v2.05\pic\include\c90\stdio.h"
struct __prbuf
{
char * ptr;
void (* func)(char);
...
# 29 "D:\Microchip\xc8\v2.05\pic\include\c90\errno.h"
extern int errno;

# 12 "D:\Microchip\xc8\v2.05\pic\include\c90\conio.h"
...
# 88 "D:\Microchip\xc8\v2.05\pic\include\c90\stdio.h"
...
# 71 "../Lab6_/main.c"
volatile int encoder1_counter;
volatile int encoder2_counter;
volatile char state1;
volatile char state2;
volatile int last_enc1_counter = 0;
volatile int last_enc2_counter = 0;
volatile int speed1;
volatile int speed2;
volatile char ab1;
volatile char ab2;
...
ab1 = (PORTB & 0b00011000) >>3;
ab2 = (PORTB & 0b00000110) >>1 ;
...
speed1 = (encoder1_counter - last_enc1_counter) * 30;
speed2 = (encoder2_counter - last_enc2_counter)* 30;
last_enc1_counter = encoder1_counter;
last_enc2_counter = encoder2_counter;
...
state2 = (PORTB & 0b00000110) >>1 ;

}

int getNearObject(){
unsigned int distance_reading;
unsigned int measured_distance;
distance_reading = sensorNear_read();
if (distance_reading < 3){
return 999;
}
measured_distance =(16245/distance_reading) + 43;
...
char sVar[9];
int countKey = 0;
static bit lineSensorState;
static bit nearSensorState;
static bit batteryLevelState;
int nearSensorData;
union chartype lineSensor;
char serialIn = 255;
char keyIn = 0;
...
distancia = getNearObject();
if (distancia > 400){
vel = 600;
}else if (distancia < 100){
vel = 0;
}else{
vel = 60+ (18*(distancia - 100)/10);
}
pwm_set(1, vel);
pwm_set(2, vel);
...
lcd_goto(0);
if (distancia <500){
sprintf(sVar, "%03d mm", distancia);
}else{
sprintf(sVar, "dist inf");
}
lcd_puts(sVar);
lcd_goto(64);
sprintf(sVar, "%03d||%03d ", speed1, speed2);
lcd_puts(sVar);
